...
Ktor (version 2.3.8) Used to deserialize JSON files into data objects
Room (version 2.6.1) Used to create a SQLite database
Mapbox (Version 11.3.1) Used for map functionality in the app
Google location (version 21.2.0) Used to retrieve user location
